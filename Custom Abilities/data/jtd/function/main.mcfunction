    # SET THE MANABANK COLOR TO GREEN WHEN THE PLAYER ISNT USING AN ABILITY
    ...
    # SUBTITLE ITEM DISPLAY MECHANICS
    ...
    # ACTIVATE ITEM ABILITIES
        ...
        # AIR
            ...
            # SPEED MECHANICS
                ...
                # remove the speed effects if windborne is deactivated
                    ...
                    execute as @a[team=JacobTheDragon] unless items entity @s weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{jtdAir:true}] if score @s jtd.ability_air_windborneSprintDuration matches 1.. unless score @s jtd.ability_air_windborneReset matches 1 run function jtd:abilities/air/jtd_ability_air_speed_remove
            ...
            # remove windbore status when player switches items, or runs out of mana
                execute as @a[team=JacobTheDragon] if items entity @s weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{jtdAir:true}] if score @s jtd.manaBank matches 0 if score @s jtd.ability_air_windborneToggle matches 1.. at @s run playsound minecraft:entity.breeze.jump master @a ~ ~ ~ 1 .5
                execute as @a[team=JacobTheDragon] if items entity @s weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{jtdAir:true}] if score @s jtd.manaBank matches 0 if score @s jtd.ability_air_windborneToggle matches 1.. at @s run playsound minecraft:block.vault.activate master @a ~ ~ ~ 1 .5
                execute as @a[team=JacobTheDragon] if items entity @s weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{jtdAir:true}] if score @s jtd.manaBank matches 0 if score @s jtd.ability_air_windborneToggle matches 1.. run title @s reset
                execute as @a[team=JacobTheDragon] if items entity @s weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{jtdAir:true}] if score @s jtd.manaBank matches 0 if score @s jtd.ability_air_windborneToggle matches 1.. run scoreboard players reset @s jtd.ability_air_windborneToggle

                execute as @a[team=JacobTheDragon] unless items entity @s weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{jtdAir:true}] if score @s jtd.ability_air_windborneToggle matches 1.. at @s run playsound minecraft:entity.breeze.jump master @a ~ ~ ~ 1 .5
                execute as @a[team=JacobTheDragon] unless items entity @s weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{jtdAir:true}] if score @s jtd.ability_air_windborneToggle matches 1.. at @s run playsound minecraft:block.vault.activate master @a ~ ~ ~ 1 .5
                execute as @a[team=JacobTheDragon] unless items entity @s weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{jtdAir:true}] if score @s jtd.ability_air_windborneToggle matches 1.. run title @s reset
                execute as @a[team=JacobTheDragon] unless items entity @s weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{jtdAir:true}] if score @s jtd.ability_air_windborneToggle matches 1.. run scoreboard players reset @s jtd.ability_air_windborneToggle
        ...
        # FIRE
            ...
            # ABILITY 1
                # damage entities that get hit by the fire, then remove the fire marker entities
        ...
        # WATER
            ...
            # ABILITY 1
                # stop charging if you crouch or let got of right-click
    ...
    # RESETS
        ...
        execute as @a[team=JacobTheDragon] if items entity @s weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{jtdAir:true}] if score @s jtd.air_rClick matches 0 run scoreboard players set @s jtd.item_spamProtection 0
        execute as @a[team=JacobTheDragon] if items entity @s weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{jtdEarth:true}] if score @s jtd.earth_rClick matches 0 run scoreboard players set @s jtd.item_spamProtection 0
        execute as @a[team=JacobTheDragon] if items entity @s weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{jtdEnder:true}] if score @s jtd.ender_rClick matches 0 run scoreboard players set @s jtd.item_spamProtection 0
        execute as @a[team=JacobTheDragon] if items entity @s weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{jtdFire:true}] if score @s jtd.fire_rClick matches 0 run scoreboard players set @s jtd.item_spamProtection 0
        execute as @a[team=JacobTheDragon] if items entity @s weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{jtdSoul:true}] if score @s jtd.soul_rClick matches 0 run scoreboard players set @s jtd.item_spamProtection 0
        execute as @a[team=JacobTheDragon] if items entity @s weapon.mainhand minecraft:stone_sword[minecraft:custom_data~{jtdWater:true}] if score @s jtd.water_rClick matches 0 run scoreboard players set @s jtd.item_spamProtection 0

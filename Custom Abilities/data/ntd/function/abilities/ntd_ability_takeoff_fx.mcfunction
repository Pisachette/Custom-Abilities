...
# actionbar
    ...
    execute unless score @s ntd.fly matches 1.. if score @s ntd.sneak matches 1.. unless score @s ntd.takeoff_charge matches 10.. run title @s actionbar [{"color":"white","text":"["},{"color":"gray","text":"||||||||||"},{"color":"white","text":"]"}]
